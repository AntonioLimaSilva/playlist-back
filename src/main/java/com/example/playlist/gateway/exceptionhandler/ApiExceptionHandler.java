...
import com.example.playlist.exception.BusinessException;
...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler(NamePlaylistNotFoundException.class)
    public ResponseEntity<?> handleNamePlaylistNotFoundException(NamePlaylistNotFoundException ex, WebRequest request) {
